...
if __name__ == '__main__':
    ...
    """
    stage1_train_src = '/allen/programs/celltypes/workgroups/em-connectomics/gayathrim/vesicle_detection/data/datasciencebowl2018/stage1_train'
    stage1_train_dest = '/allen/programs/celltypes/workgroups/em-connectomics/gayathrim/vesicle_detection/data/datasciencebowl2018/combined'
    stage1_test_src = '/allen/programs/celltypes/workgroups/em-connectomics/gayathrim/vesicle_detection/data/datasciencebowl2018/stage1_test'
    stage1_test_dest = '/allen/programs/celltypes/workgroups/em-connectomics/gayathrim/vesicle_detection/data/datasciencebowl2018/testing_data'
